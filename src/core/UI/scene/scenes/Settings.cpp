...
Settings::Settings() : Scene("SETTINGS") {
    ...
    saveButton = std::make_unique<Button>(glm::vec2(25, game -> getSize().y) - glm::vec2(0, 75), glm::vec2(200, 50), "Save", HEXtoRGB(0x4444FF));
...
void Settings::resize() {
    saveButton -> setPosition(glm::vec2(25, game -> getSize().y) - glm::vec2(0, 75));
